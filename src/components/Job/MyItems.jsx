...
const MyItems = () => {
    ...
    const fetchItems = async () => {
      try {
        const { data } = await axios.get(
          "https://lost-and-found-backend-5.onrender.com/api/v1/job/getmyjobs", //
  ...
  const handleUpdateItem = async (ItemId) => {
    ...
    await axios
      .put(`https://lost-and-found-backend-5.onrender.com/api/v1/job/update/${ItemId}`, updatedItem, {
        withCredentials: true,
      })
      .then((res) => {
  ...
  const handleDeleteItem = async (ItemId) => {
    await axios
      .delete(`https://lost-and-found-backend-5.onrender.com/api/v1/job/delete/${ItemId}`, {
        withCredentials: true,
      })
      .then((res) => {
        toast.success(res.data.message);
