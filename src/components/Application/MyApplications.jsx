...
const MyApplications = () => {
      ...
      try {
        if (user && user.role === "Employer") {
          const response = await axios.get(
            "https://lost-and-found-backend-5.onrender.com/api/v1/application/employer/getall",
            {
          ...
          const response = await axios.get(
            "https://lost-and-found-backend-5.onrender.com/api/v1/application/jobseeker/getall",
            {
              withCredentials: true,
            }
          );
  ...
  const deleteApplication = (id) => {
    try {
      axios
        .delete(`https://lost-and-found-backend-5.onrender.com/api/v1/application/delete/${id}`, {
          withCredentials: true,
        })
        .then((res) => {
  ...
  const employeedeleteApplication = (id) => {
    try {
      ...
      axios
        .delete(
          `https://lost-and-found-backend-5.onrender.com/api/v1/application/deleteemployee/${id}`,
          {
            withCredentials: true,
          }
        )
  ...
  const validateApplication = async (id) => {
    try {
      ...
      const response = await axios.put(
        `https://lost-and-found-backend-5.onrender.com/api/v1/application/application/${applicationId}`,
        {},
        { withCredentials: true }
      );
...
const JobSeekerCard = ({
  ...
  axios
    .get(
      `https://lost-and-found-backend-5.onrender.com/api/v1/user/getemployee/${element.employerID.user}`,
      {
        withCredentials: true,
      }
    )
